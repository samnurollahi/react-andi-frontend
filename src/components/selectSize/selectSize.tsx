...
export default function ({ setSize, size }: { setSize: any; size: any }) {
  const [select, setSelected] = useState<null | string>(null);

  return (
    <>
      <div className="flex h-[98vh] w-full justify-center items-center flex-col flex-wrap">
        ...
        <div className="text-center">
          <button
            className="cursor-pointer transition bg-indigo-600 active:bg-indigo-500 text-white rounded-sm px-5 py-2 mt-5"
            onClick={() => {
              setSize(select);
            }}
          >
